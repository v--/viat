...
def load_storage_from_config(resolver: ViatPathResolver, loader: ConfigLoader) -> ViatAttributeStorage:
...
def load_toml_storage_from_config(resolver: ViatPathResolver, loader: ConfigLoader) -> TomlAttributeStorage:
...
def load_json_storage_from_config(resolver: ViatPathResolver, loader: ConfigLoader) -> JsonAttributeStorage:
